...
export default class AtomusCard_Assignment extends Component {
    constructor(props) {
        super(props);
    }

    onPress = () => {
        this.props.onPress(this.props.assignment);
    };
...
AtomusCard_Assignment.propTypes = {
    name: PropTypes.string,
    onPress: PropTypes.func,
}

AtomusCard_Assignment.defaultProps = {
    name: "CS4261",
